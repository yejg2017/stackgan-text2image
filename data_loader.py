...
if dataset == '102flowers':
    ...
    """
    cwd = '/home/ye/user/yejg/LEARN/DL_MODEL_LEARN/TensorFlow/GAN/stack-text-to-image'
    img_dir = os.path.join(cwd, '102flowers')
    caption_dir = os.path.join('/home/ye/user/yejg/LEARN/DL_MODEL_LEARN/TensorFlow/GAN/stack-text-to-image/cvpr2016_flowers/', 'text_c10')
    VOC_FIR = '/home/ye/user/yejg/LEARN/DL_MODEL_LEARN/TensorFlow/GAN/stack-text-to-image/cvpr2016_flowers/'+ '/vocab.txt'
...
save_all(vocab, './Data/_vocab.pickle')
save_all((images_train_256, images_train), './Data/_image_train.pickle')
save_all((images_test_256, images_test), './Data/_image_test.pickle')
save_all((n_captions_train, n_captions_test, n_captions_per_image, n_images_train, n_images_test), './Data/_n.pickle')
save_all((captions_ids_train, captions_ids_test), './Data/_caption.pickle')
